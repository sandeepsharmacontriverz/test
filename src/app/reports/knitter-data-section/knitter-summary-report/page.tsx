...
const KnitterSummaryReport: any = () => {
  const [roleLoading] = useRole();
  useTitle("Knitter Summary Report");
  ...
  const handleExport = async () => {
    const url = "reports/export-knitter-summary-report";
    try {
      const response = await API.get(url);
      if (response.success) {
        if (response.data) {
          handleDownload(response.data, "Cotton Connect - Knitter Summary Report", ".xlsx");
        }
      }
    } catch (error) {
  ...
  const getReports = async () => {
    const url = `reports/get-knitter-summary-report?search=${searchQuery}&countryId=${checkedCountries}&brandId=${checkedBrands}&programId=${checkedPrograms}&stateId=${checkedStates}&knitterId=${checkedKnitters}&page=${page}&limit=${limit}&pagination=true`;
    try {
      const response = await API.get(url);
                        ...
                        <div className="col-12 col-md-6 col-lg-3 mt-2">
                          ...
                          <Multiselect
                            ...
                            onRemove={(selectedList: any, selectedItem: any) => {
                              handleChange(selectedList, selectedItem, "knitter");
                            }}
                            onSearch={function noRefCheck() { }}
                            onSelect={(selectedList: any, selectedItem: any) =>
                              handleChange(selectedList, selectedItem, "knitter")
                    ...
                    <div className="border-y-2 py-5 my-5">
                      <div className="row">
                        ...
                        <div className="col-md-4 col-sm-12">
                          <Accordian
                            title={"Knitter Summary Procurement 2023-2024"}
                            content={
                              <BarChart
                                title={"Knitter Summary Procurement 2023-2024"}
                                data={chartData}
                      ...
                      <div className="row">
                        <div className="col-md-4 col-sm-12">
                          <Accordian
                            title={"Knitter Summary 2022-2023"}
                            content={
                              <BarChart
                                title={"Knitter Summary 2022-2023"}
                                data={chartData}
                        ...
                        <div className="col-md-4 col-sm-12">
                          <Accordian
                            title={"Knitter Summary 2021-2022"}
                            content={
                              <BarChart
                                title={"Knitter Summary 2021-2022"}
                                data={chartData}
                        ...
                        <div className="col-md-4 col-sm-12">
                          <Accordian
                            title={"Knitter Summary 2020-2021"}
                            content={
                              <BarChart
                                title={"Knitter Summary 2020-2021"}
                                data={chartData}
...
export default KnitterSummaryReport;
