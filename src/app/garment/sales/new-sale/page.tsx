...
export default function page() {
  ...
  useEffect(() => {
    ...
    if (storedTotal !== null && storedTotal !== undefined) {
      ...
      if (chooseYarnItems && chooseYarnItems.length > 0) {
        ...
        const brandOrderSet = new Set(chooseYarnItems?.map((item: any) => item.brandOrderRef));
        const brandOrder = [...brandOrderSet].join(', ');

        const fabricOrderSet = new Set(chooseYarnItems?.map((item: any) => item.garmentOrderRef));
  ...
  const handleSubmit = async (event: any) => {
    ...
    if (formData?.totalNoOfPieces === null || formData?.totalNoOfBoxes &&
                  ...
                  <div className="row">
                    ...
                    {formData.buyerType === "Mapped" && (
                      <>
                        <div className="col-6 mt-4 ">
                          ...
                          <Select
                            name="buyerId"
                            value={formData.buyerId ? { label: brands?.find((brand: any) => brand.id === formData.buyerId)?.brand_name, value: formData.buyerId } : null}
                            menuShouldScrollIntoView={false}
                            isClearable
                    ...
                    {formData.buyerType === "New Buyer" && (
                      <>
                        <div className="col-6 mt-4 ">
                          ...
                          <Select
                            name="traderId"
                            value={formData.traderId ? { label: processors?.find((trader: any) => trader.id === formData.traderId)?.name, value: formData.traderId } : null}
                            menuShouldScrollIntoView={false}
                            isClearable
                            placeholder={translations?.common?.selectProcesor}
                            className="dropDownFixes rounded-md formDropDown mt-1 text-sm borderBottom"
                            options={(processors || []).map(({ id, name }: any) => ({
                              label: name,
                              value: id,
                              key: id
                            }))}
                    ...
                    <div className="col-12 col-sm-6 mt-4">
                      ...
                      <textarea
                        ...
                        onChange={(e) => handleChange("shipmentAddress", e.target.value)}
                      ...
                      <div className="row">
                        ...
                        <div className="col-12 col-sm-6 mt-4">
                          ...
                          <input
                            ...
                            onChange={(e) => handleChange("transportorName", e.target.value)}
