...
export default function page() {
  ...
  const [formData, setFormData] = useState<any>({
    ...
    garmentId: null,
    fabricId: null,
    deletedGinnerId: null,
    deletedSpinnerId: null,
  ...
  useEffect(() => {
    const matchNames: any = yarnType
      .filter((yarnType: any) => formData?.yarnType?.includes(yarnType.name))
  ...
  useEffect(() => {
    const matchNames: any = yarnCountRange
      .filter((yarnCountRange: any) =>
        formData?.yarnCountRange?.includes(yarnCountRange.id)
      )
    ...
    try {
      ...
      if (res.success) {
        ...
        setFormData({
          ...
          email: data.email,
          outturnRangeFrom: res.data?.ginner?.outturn_range_from,
          outturnRangeTo: res.data?.ginner?.outturn_range_to,
          baleWeightFrom: res.data?.ginner?.bale_weight_from,
          baleWeightTo: res.data?.ginner?.bale_weight_to,
          ginType: res.data?.ginner?.gin_type,
          rangeFrom: res.data?.spinner?.realisation_range_from,
          rangeTo: res.data?.spinner?.realisation_range_to,
          yarnCountRange: res.data?.spinner?.yarn_count_range,
          yarnType: res.data?.spinner?.yarn_type,
          ...
          ginnerId: res.data.ginner ? res.data.ginner.id : null,
          spinnerId: res.data?.spinner ? res.data.spinner.id : null,
          knitterId: res.data?.knitter ? res.data.knitter.id : null,
          weaverId: res.data?.weaver ? res.data.weaver.id : null,
  ...
  const handleSelectionChange = (
    ...
    if (name === "processType") {
      ...
      if (deselectedIntial.length > 0) {
        if (deselectedIntial.includes("Ginner")) {
          setFormData((prevData: any) => ({
            ...prevData,
            deletedGinnerId: formData.ginnerId,
            ginnerId: null,
          }));
        } else if (deselectedIntial.includes("Spinner")) {
          setFormData((prevData: any) => ({
            ...prevData,
            deletedSpinnerId: formData.spinnerId,
            spinnerId: null,
          }));
        } else if (deselectedIntial.includes("Knitter")) {
          setFormData((prevData: any) => ({
            ...prevData,
            deletedKnitterId: formData.knitterId,
            knitterId: null,
          }));
        } else if (deselectedIntial.includes("Weaver")) {
          setFormData((prevData: any) => ({
            ...prevData,
            deletedWeaverId: formData.weaverId,
            weaverId: null,
          }));
        } else if (deselectedIntial.includes("Garment")) {
          setFormData((prevData: any) => ({
            ...prevData,
            deletedGarmentId: formData.garmentId,
            garmentId: null,
          }));
        ...
        if (selectedOptions.includes("Ginner") && formData.deletedGinnerId) {
          setFormData((prevData: any) => ({
            ...prevData,
            ginnerId: formData.deletedGinnerId,
            deletedGinnerId: null,
          }));
        } else if (
          selectedOptions.includes("Spinner") &&
          formData.deletedSpinnerId
        ) {
          setFormData((prevData: any) => ({
            ...prevData,
            spinnerId: formData.deletedSpinnerId,
            deletedSpinnerId: null,
          }));
        } else if (
          selectedOptions.includes("Knitter") &&
          formData.deletedKnitterId
        ) {
          setFormData((prevData: any) => ({
            ...prevData,
            knitterId: formData.deletedKnitterId,
            deletedKnitterId: null,
          }));
        } else if (
          selectedOptions.includes("Weaver") &&
          formData.deletedWeaverId
        ) {
          setFormData((prevData: any) => ({
            ...prevData,
            weaverId: formData.deletedWeaverId,
            deletedWeaverId: null,
          }));
        } else if (
          selectedOptions.includes("Garment") &&
          formData.deletedGarmentId
        ) {
          setFormData((prevData: any) => ({
            ...prevData,
            garmentId: formData.deletedGarmentId,
            deletedGarmentId: null,
          }));
        } else if (
          selectedOptions.includes("Trader") &&
          formData.deletedTraderId
        ) {
          setFormData((prevData: any) => ({
            ...prevData,
            traderId: formData.deletedTraderId,
            deletedTraderId: null,
          }));
        } else if (
          selectedOptions.includes("Fabric") &&
          formData.deletedTraderId
        ) {
          setFormData((prevData: any) => ({
            ...prevData,
            fabricId: formData.deletedFabricId,
            deletedFabricId: null,
          }));
        }
      }
        ...
        switch (name) {
          ...
          case "baleWeightTo":
            return (value === "" || value === null || value == undefined) &&
              selectedProcessor.includes("Ginner")
              ? "This Field is required"
              : "";
          case "rangeFrom":
          case "rangeTo":
            return (value === "" || value === null || value == undefined) &&
              selectedProcessor.includes("Spinner")
              ? "This Field is required"
              : "";
    ...
    if (!hasErrors && !hasUserErrors && !errors.name) {
      ...
      try {
        const response = await API.put("new-processor", {
          ...formData,
          yarnCountRange: formData.yarnCountRange
            ? String(formData.yarnCountRange)
            : null,
          yarnType: formData.yarnType ? String(formData.yarnType) : null,
  ...
  const alreadyExistName = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!valid) {
      ...
      const res = await API.post("new-processor/check-name", {
        // id: id,
        name: value,
        ginnerId: formData.ginnerId,
        spinnerId: formData.spinnerId,
        garmentId: formData.garmentId,
        knitterId: formData.knitterId,
                            ...
                            <div key={item}>
                              {item === "Ginner" && (
                                <div className="row mt-3">
                                  ...
                                  <div className="col-12 col-sm-6 mt-4">
                                    <label className="text-gray-500 text-[12px] font-medium">
                                      Gin Out Turn Range <span className="text-red-500">*</span>
                                    </label>
                                    <div className="row">
                                      <div className="col-12 col-sm-6">
                                        <input
                              ...
                              {item === "Spinner" && (
                                <div className="row mt-4">
                                  ...
                                  <div className="col-12 col-sm-6 mt-4">
                                    <label className="text-gray-500 text-[12px] font-medium">
                                      Yarn Realisation Range <span className="text-red-500">*</span>
                                    </label>
                                    <div className="row">
                                      <div className="col-12 col-sm-6">
                                        <input
