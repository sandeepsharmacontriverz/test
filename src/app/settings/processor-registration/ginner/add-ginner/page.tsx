  ...
  const handleSubmit = async (event: any) => {
    ...
    if (
      ...
      try {
        ...
        if (response.success) {
          toasterSuccess("ginner Successfully Created");
          router.push("/settings/processor-registration/ginner");
        }
      } catch (error) {
      ...
      <div>
        ...
        <div className="justify-between mt-4 px-2 space-x-3 ">
          ...
          <button
            ...
            onClick={() => router.push('/settings/processor-registration/ginner')}
          >
            Cancel
          </button>
        </div>
