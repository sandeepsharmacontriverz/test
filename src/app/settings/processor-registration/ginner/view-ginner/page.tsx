...
export default function page() {
  ...
  const getGinnerData = async () => {
    const url = `ginner/get-ginner?id=${id}`;
    try {
    ...
    return (
      <div className="text-xs px-3 font-bold">
        ...
        <div className="flex mt-1">
          ...
          <div className="w-1/2">
            <p className="">{ginnerData?.short_name}</p>
          </div>
        </div>
        ...
        <div className="flex mt-1">
          ...
          <div className="w-1/2">
            <p className="">{ginnerData?.address}</p>
          </div>
        </div>
        <div className="flex mt-1">
          <div className="w-1/2">
          ...
          <div className="w-1/2">
            <p className="">{ginnerData?.country?.county_name}</p>
          </div>
        </div>
        <div className="flex mt-1">
          <div className="w-1/2">
          ...
          <div className="w-1/2">
            <p className="">{ginnerData?.state?.state_name}</p>
          </div>
        </div>
        <div className="flex mt-1">
          <div className="w-1/2">
          ...
          <div className="w-1/2">
            <p className="">{ginnerData?.district?.district_name}</p>
          </div>
        </div>
        ...
        <div className="flex mt-1">
          ...
          <div className="w-1/2">
            <p className="">
              {ginnerData?.latitude},{ginnerData?.longitude}
            </p>
          </div>
        </div>
        ...
        <div className="flex mt-1">
          ...
          <div className="w-1/2">
            <p className="">{ginnerData?.website}</p>
          </div>
        </div>
        <div className="flex mt-1">
          <div className="w-1/2">
          ...
          <div className="w-1/2">
            <p className="">{ginnerData?.contact_person}</p>
          </div>
        </div>
      </div>
    );
  };
  const ginnerInformation = () => {
    return (
      <div className="text-xs px-3 font-bold">
        <div className="flex mt-1">
          <div className="w-1/2">
            <p>Gin Outurn Range - From:</p>
          </div>
          <div className="w-1/2">
            <p className="">{ginnerData?.outturn_range_from}</p>
          </div>
        </div>

        <div className="flex mt-1">
          <div className="w-1/2">
            <p>Gin Outurn Range - To:</p>
          </div>
          <div className="w-1/2">
            <p className="">{ginnerData?.outturn_range_to}</p>
          </div>
        </div>

        <div className="flex mt-1">
          <div className="w-1/2">
            <p>Bale Weight Range - From:</p>
          </div>
          <div className="w-1/2">
            <p className="">{ginnerData?.bale_weight_from}</p>
          </div>
        </div>

        <div className="flex mt-1">
          <div className="w-1/2">
            <p>Bale Weight Range - To:</p>
          </div>
          <div className="w-1/2">
            <p className="">{ginnerData?.bale_weight_to}</p>
          </div>
        </div>
        <div className="flex mt-1">
          <div className="w-1/2">
        ...
        <div className="flex mt-1">
          ...
          <div className="w-1/2">
            <p className="">{ginnerData?.company_info}</p>
          </div>
        </div>
        ...
        <div className="flex mt-1">
          ...
          <div className="w-1/2">
            {ginnerData?.brands &&
              ginnerData.brands.map((name: any) => name.brand_name).join(", ")}
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="text-xs px-3 font-bold">
        <div className="flex mt-1">
          ...
          <div className="w-1/2">
            <p className="">{ginnerData?.mobile}</p>
          </div>
        </div>
        ...
        <div className="flex mt-1">
          ...
          <div className="w-1/2">
            <p className="">{ginnerData?.landline}</p>
          </div>
        </div>
        ...
        <div className="flex mt-1">
          ...
          <div className="w-1/2">
            <p className="">{ginnerData?.email}</p>
          </div>
        </div>
        ...
        <div className="flex mt-1">
          ...
          <div className="w-1/2">
            <p className="">{ginnerData?.gin_type}</p>
          </div>
        </div>
      </div>
    );
  ...
  const userAccess = () => {
    return (
      <div>
        {ginnerData?.userData?.map((user: any, index: number) => {
          return (
        ...
        {hasAccess?.edit && (
          <div className="search-filter-right">
            <button
              ...
              onClick={() =>
                router.push(
                  `/settings/processor-registration/edit-processor?id=${id}&type=Ginner`
                )
              }
            >
              Edit
