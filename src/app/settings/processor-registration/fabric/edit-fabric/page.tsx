...
export default function page() {
    ...
    const getPrevData = async () => {
        const url = `fabric/get-fabric?id=${selectedId}`
        try {
            ...
            setProcessorFormData(
                {
                    ...
                    fabricType: prevData.fabric_processor_type,
    ...
    const handleSubmit = async (event: any) => {
        ...
        if (
            ...
            try {
                const response = await API.put("fabric/update-fabric", {
                    ...processorFormData,
                    id: selectedId,
                    userData: users
                });
                if (response.success) {
                    toasterSuccess("Fabric updated Successfully");
            ...
            if (processorFormData.name === "") {
                setErrors((pre) => ({
                    ...pre,
                    name: "Fabric Unit Name is required"
                }))
            }
