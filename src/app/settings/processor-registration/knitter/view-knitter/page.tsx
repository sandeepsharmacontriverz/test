...
export default function page() {
  ...
  const getWeaverData = async () => {
    const url = `knitter/get-knitter?id=${id}`;
    try {
    ...
    return (
      <div className="w-full text-xs px-3 ">
        <div className="flex full mt-2 justify-between">
          ...
          <div className="w-1/2">
            <p>{KnitterData?.no_of_machines}</p>
          </div>
        </div>
        <div className="flex full mt-2 justify-between">
          <div className="w-1/2">
          ...
          <div className="w-1/2">
            <p>{getFabricTypeName(KnitterData?.fabric_type)}</p>
          </div>
        </div>
        <div className="flex full mt-2 justify-between">
          <div className="w-1/2">
          ...
          <div className="w-1/2">
            <p>{getProductionName(KnitterData?.prod_cap)}</p>
          </div>
        </div>
        <div className="flex full mt-2 justify-between">
          <div className="w-1/2">
          ...
          {hasAccess?.edit && (
            <div className="search-filter-right">
              <button
                ...
                onClick={() =>
                  router.push(
                    `/settings/processor-registration/edit-processor?id=${id}&type=Knitter`
                  )
                }
              >
                Edit
