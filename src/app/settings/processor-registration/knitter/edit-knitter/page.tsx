...
export default function page() {
    ...
    const getPrevData = async () => {
        const url = `knitter/get-knitter?id=${selectedId}`
        try {
    ...
    const handleSubmit = async (event: any) => {
        ...
        if (
            ...
            try {
                ...
                if (response.success) {
                    toasterSuccess("Knitter updated Successfully");
                    router.push("/settings/processor-registration/knitter");
                }
            } catch (error) {
            ...
            if (processorFormData.name === "") {
                setErrors((pre) => ({
                    ...pre,
                    name: "Knitter Unit Name is required"
                }))
            }
