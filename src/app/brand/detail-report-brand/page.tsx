...
export default function Page() {
  ...
  const columns = [
    ...
    {
      name: <p className="text-[13px] font-medium"> Gin/Spin Lot No </p>,
    ...
    },
    {
      name: (
        <p className="text-[13px] font-medium">
          {translations.qualityParameter?.labName}
        </p>
      ),
    ...
    },
    {
      ...
      selector: (row: any) => row.test_report?.substring(0, 10),
      wrap: true,
    },
    {
      name: (
    ...
    },
    {
      name: (
        <p className="text-[13px] font-medium">
          {" "}
          {translations.qualityParameter?.rd}{" "}
        </p>
      ),
    ...
    },
    {
      name: (
        <p className="text-[13px] font-medium">
          {" "}
          {translations.qualityParameter?.document}{" "}
        </p>
      ),
      cell: (row: any) =>
            ...
            <div className="breadcrumb-inner light-bg">
              <div className="breadcrumb-left">
                <ul className="breadcrum-list-wrap">
                  ...
                  <li><Link href="/brand/cotton-quality-parameter">Cotton Quality Parameter </Link></li>
                  <li>Detail Report</li>
                </ul>
              </div>
            </div>
                    ...
                    <div className="search-bars mb-4">
                      ...
                      <span className="text-sm ml-5">
                        {data &&
                          data?.map((item: any) => {
                            return item?.process
                              ? dateFormatter(item?.process?.date)
                              : dateFormatter(item?.sales?.date);
                          })}
                      </span>
                    </div>
                  </div>
                  <div className="search-filter-row">
                    ...
                    <div className="customButtonGroup">
                      <button
                        ...
                        onClick={() =>
                          router.push("/brand/cotton-quality-parameter")
                        }  >
                        Go Back
                      </button>
                    </div>
