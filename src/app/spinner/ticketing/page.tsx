...
export default function page() {
  ...
  const fetchTicketing = async () => {
    try {
      const res = await API.get(
        `ticketing?processor=Spinner&processorId=${spinnerId}&search=${searchQuery}&processSale=${checkedType}&from=${startDates ? startDates?.toISOString() : ""
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row: any) => (
        <Link
          href={`/spinner/ticketing/view-ticket?id=${row.id}`}
        >
                          ...
                          {Access.create &&
                            <div className="search-filter-right">
                              <button
                                ...
                                onClick={() =>
                                  router.push("/spinner/ticketing/add-ticket")
                                }
                              >
                                Create Ticket
                              </button>
