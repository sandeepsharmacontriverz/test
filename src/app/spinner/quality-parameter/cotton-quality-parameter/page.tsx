  ...
  const [Access, setAccess] = useState<any>({});
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row: any) => (
                <>
                    <button className="text-white py-2 px-2 mr-3 rounded-md bg-green-600  hover:text-white" onClick={() => router.push(`/spinner/quality-parameter/detail-report-spinner?id=${row.id}`)}>
