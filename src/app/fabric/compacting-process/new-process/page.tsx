...
export default function page() {
  useTitle("Compacting New Process");
  ...
  useEffect(() => {
    const savedData: any = sessionStorage.getItem("fabricData");
  ...
  useEffect(() => {
    const storedTotal = sessionStorage.getItem("chooseFabric");
  ...
  const getChooseYarn = () => {
    if (formData.programId) {
      sessionStorage.setItem("fabricData", JSON.stringify(formData));
      router.push(
        `/fabric/compacting-process/choose-fabric?id=${formData.programId}`
      );
    } else {
      setErrors((prev: any) => ({
        ...prev,
  ...
  const handleChange = (name?: any, value?: any, event?: any) => {
    if (name === "programId") {
    ...
    } else if (name === "blend" || name === "dyeing") {
      setFormData((prevFormData: any) => ({
        ...prevFormData,
      ...
      setFormData((prevData: any) => ({
        ...prevData,
        transactionViaTrader: value === "Yes" ? true : false,
      }));
    } else {
      if (name === "otherDocs" || name === "invoiceFiles") {
  ...
  const handleSubmit = async (event: any) => {
    ...
    if (!hasWeaversErrors) {
      try {
        ...
        const response = await API.post("fabric-process/compacting-process", {
          ...formData,
          compactingFabricId: fabricId,
        ...
        if (response.success) {
          ...
          router.push(`/fabric/compacting-process`);
        } else {
            ...
            <div className="breadcrumb-inner light-bg">
              <div className="breadcrumb-left">
                <ul className="breadcrum-list-wrap">
                  ...
                  <li>
                    <NavLink href="/fabric/compacting-process" className="active">
                      Process/Sale
                    </NavLink>
                  </li>
                  <li>New Process </li>
                  ...
                  <div className="row">
                    ...
                    <div className=" col-12 col-sm-6 mt-4">
                      ...
                      <input
                        ...
                        onBlur={(e) => onBlur(e, "bill")}
                        placeholder="Washing Details"
                        onChange={(e) => handleChange("washingDetails", e.target.value)}
                        type="text"
                        className="w-100 shadow-none h-11 rounded-md mt-1 form-control gray-placeholder text-gray-500 text-sm borderCustom"
                      />
                      {errors?.washingDetails !== "" && (
                        <div className="text-sm text-red-500">
                          {errors.washingDetails}
                        </div>
                      )}
                    ...
                    <div className="col-12 col-sm-6 mt-4">
                      <label className="text-gray-500 text-[12px] font-medium">
                        Type of Wash <span className="text-red-500">*</span>
                      </label>
                      <input
                        name="wash_type"
                        value={formData.wash_type}
                        onChange={(e) => handleChange("wash_type", e.target.value)}
                        onBlur={(e) => onBlur(e, "bill")}
                        type="text"
                    ...
                    <div className="col-12 col-sm-6 mt-4">
                      <label className="text-gray-500 text-[12px] font-medium">
                        Finished Compacted Fabric Length in Mts{" "}
                        <span className="text-red-500">*</span>
                      </label>
                    ...
                    <div className="col-12 col-sm-6 mt-4">
                      <label className="text-gray-500 text-[12px] font-medium">
                        Finished Compacted Fabric Net Weight{" "}
                        <span className="text-red-500">*</span>
                      </label>
                      <input
                    ...
                    <div className=" col-12 col-sm-6 mt-4">
                      ...
                      <input
                        name="compactingDetails"
                        value={formData.compactingDetails}
                        onBlur={(e) => onBlur(e, "bill")}
                        placeholder="Compacting Details"
                        onChange={(e) => handleChange("compactingDetails", e.target.value)}
                        type="text"
                        className="w-100 shadow-none h-11 rounded-md mt-1 form-control gray-placeholder text-gray-500 text-sm borderCustom"
                      />
                      {errors.compactingDetails && (
                        <p className="text-red-500  text-sm mt-1">
                          {errors.compactingDetails}
                        </p>
                      )}
                    ...
                    <div className="col-12 col-sm-6 mt-4">
                      <label className="text-gray-500 text-[12px] font-medium">
                        Type of Compact <span className="text-red-500">*</span>
                      </label>
                      <input
                        name="typeOfCompact"
                        value={formData.typeOfCompact}
                        onBlur={(e) => onBlur(e, "bill")}
                        onChange={(e) => handleChange("typeOfCompact", e.target.value)}
                        type="text"
                        placeholder="Type of Compact"
                        className="w-100 shadow-none h-11 rounded-md mt-1 form-control gray-placeholder text-gray-500 text-sm borderCustom"
                      />
                      {errors?.typeOfCompact && (
                        <div className="text-sm text-red-500">
                          {errors.typeOfCompact}
                        </div>
                      )}
                            ...
                            <div className="flex text-sm mt-1" key={index}>
                              ...
                              <div className="w-1/3">
                                <button
                                  ...
                                  type="button"
                                  onClick={() =>
                                    removeImage(index, "invoiceFiles")
                                  }
