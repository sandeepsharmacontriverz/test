...
export default function Page() {
  ...
  if (!roleLoading && Access?.view && isLoaded) {
            ...
            <div className="breadcrumb-inner light-bg">
              <div className="breadcrumb-left">
                <ul className="breadcrum-list-wrap">
                  ...
                  <li><NavLink href="/ginner/quality-parameter/cotton-quality-parameter/">Cotton Quality Parameter</NavLink></li>
                  <li>Detail Report</li>
                </ul>
              </div>
            </div>
                  ...
                  <div className="search-filter-row">
                    ...
                    <div className="customButtonGroup">
                      <button
                        ...
                        onClick={() => router.push("/ginner/quality-parameter/cotton-quality-parameter")}
                      >
                        Go Back
                      </button>
                    </div>
